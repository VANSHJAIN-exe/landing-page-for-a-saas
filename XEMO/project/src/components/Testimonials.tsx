  ...
  return (
    <section className="py-24 bg-black border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold tracking-tight">What Students Say</h2>
          <p className="mt-4 text-lg text-gray-400">Join thousands of satisfied learners</p>
        </motion.div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative p-8 rounded-2xl border border-white/10 backdrop-blur-sm bg-white/5 group hover:bg-white/10 transition-colors"
            >
              <Quote className="absolute top-6 right-6 h-12 w-12 text-white/10 group-hover:text-white/20 transition-colors" />

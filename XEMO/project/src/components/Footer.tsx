        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight">xemo</span>
            </div>
            <p className="mt-4 text-gray-400 text-sm leading-relaxed">
              Revolutionizing learning through AI-powered tools and immersive 3D visualization.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-300">Legal</h4>
            <ul className="mt-4 space-y-3">
              <li>
